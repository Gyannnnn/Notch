...
export default function TodayScreen() {
  ...
  return (
    <Screen tabBarPadding>
      ...
      <Animated.View entering={stagger(1)} className="pt-xs">
        <DayNav dateKey={dateKey} onChange={setDateKey} />
      </Animated.View>

      <Animated.View entering={stagger(2)} className="center py-lg">
        <CalorieRing consumed={data.totals.calories} target={data.targets.calories} />
      </Animated.View>

      <Animated.View entering={stagger(3)} className="row gap-xs">
      ...
      {data.isToday && (
        <>
          <Animated.View entering={stagger(5)} className="mt-lg gap-xs">
      ...
      <Animated.View entering={stagger(7)} className="mt-lg">
        <MealList
